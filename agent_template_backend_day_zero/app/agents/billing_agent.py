...
# ============================================================================
# IMPLEMENTAÇÃO ORIGINAL COMENTADA - EXEMPLO DE AGENTE DE BILLING/FATURAS
# ============================================================================
...
#         ]
#         answer = await self._invoke_llm_cached(state, "BillingAgent", messages)
#         return {"answer": f"[BillingAgent] {answer}", "next_state": "BILLING_ACTIVE", "mcp_results": tool_context, "rag": rag_metadata}
#
#
#     async def _collect_tool_context(self, state):
#         return await self._collect_mcp_context(state)
