...
# ============================================================================
# IMPLEMENTAÇÃO ORIGINAL COMENTADA - EXEMPLO DE AGENTE DE PRODUTOS/PLANOS/SERVIÇOS
# ============================================================================
...
#         ]
#         answer = await self._invoke_llm_cached(state, "ProductAgent", messages)
#         return {"answer": f"[ProductAgent] {answer}", "next_state": "PRODUCT_ACTIVE", "mcp_results": tool_context, "rag": rag_metadata}
#
#
#     async def _collect_tool_context(self, state):
#         return await self._collect_mcp_context(state)
