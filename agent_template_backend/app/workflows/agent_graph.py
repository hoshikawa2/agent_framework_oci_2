...
class AgentWorkflow:
    ...
    def __init__(self, llm, memory, telemetry, event_publisher, settings, tool_router=None):
        self.llm = llm
        self.memory = memory
    ...
    def _build_graph(self):
        ...
        builder.add_edge("billing_agent", "output_guardrails")
        builder.add_edge("product_agent", "output_guardrails")
        builder.add_edge("orders_agent", "output_guardrails")
        builder.add_edge("support_agent", "output_guardrails")
        builder.add_edge("handoff", "output_guardrails")
        builder.add_edge("supervisor_agent", "output_guardrails")
